...
<div class="wrap">
  ...
  <form method="post">
    <?php nonce_field('arm_expense_save', 'arm_expense_nonce'); ?>
    ...
    <table class="form-table">
      <tr>
        ...
        <td><input type="date" id="expense-date" name="transaction_date" value="<?php echo esc_attr($edit->transaction_date ?? date('Y-m-d', current_time('timestamp'))); ?>" required></td>
      </tr>
      <tr>
    ...
    <?php if ($rows): foreach ($rows as $row): ?>
      <tr>
        ...
        <td>
          ...
          <?php $delete_link = nonce_url(add_query_arg('delete', (int) $row['id']), 'arm_expense_delete'); ?>
